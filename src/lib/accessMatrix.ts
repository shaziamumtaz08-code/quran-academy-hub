...
export const ACCESS_MATRIX: ModuleAccess[] = [
  ...
  { id:'my_quizzes',          route:'/my-quizzes',             roles:{...adminFull, teacher:VIEW_ONLY, student:VIEW_ONLY, parent:VIEW_ONLY}, group:'teaching' },
  ...
  { id:'qa_testmate',         route:'/qa-testmate',            roles:{super_admin:ADMIN_FULL}, group:'settings' },
