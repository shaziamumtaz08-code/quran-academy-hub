  ...
  const { data: assignments = [] } = useQuery({
    ...
    queryFn: async () => {
      const { data } = await supabase
        ...
        .select('id, teacher_id, student_id, effective_from_date, effective_to_date, status_effective_date, status, is_temporary, original_assignment_id, profiles!student_teacher_assignments_student_id_fkey(full_name)')
