...
BEGIN
  ...
  -- Effective start = the LATER of the plan's effective_from and the assignment's effective_from_date.
  -- This ensures that reactivating an assignment with a later date clears invoices from before it.
  eff_start := GREATEST(
